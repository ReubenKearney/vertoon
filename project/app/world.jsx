// world.jsx — series catalogue, seasons, arcs, character bible & visual-dev model
// for the three new workspaces. Extends data.jsx; everything lands on window.

// ---- The catalogue: WORDWERX holds many comics --------------------------
const SERIES = [
  {
...
// ---- Seasons & episodes (Echo's Location, fully spec\u2019d) ------------------
const SEASONS = [
  {
...
// ---- Arcs / throughlines woven across the season ------------------------
const ARCS = [
  {
...
// ---- Deepened character bible (keyed onto data.jsx CHARACTERS) ----------
const BIBLE = {
...
// ---- Visual development: subjects, explorations, locked references ------
function mkVar(v, scene, hue, state, note) { return { v, scene, hue, state, note }; }
const VISDEV = [
  {
...
// ---- Co-pilot seeds for the new workspaces ------------------------------
const COPILOT_X = {
  series: [
...
Object.assign(window, { SERIES, SEASONS, ARCS, BIBLE, VISDEV, COPILOT_X });
